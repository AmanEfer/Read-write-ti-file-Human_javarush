...
public class Solution {
    ...
    public static class Human {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String isPersonPresent = name != null ? "yes" : "no";
            String isAssetsPresent = assets != null ? "yes" : "no";

            outputStream.write(isPersonPresent.getBytes());
            outputStream.write("\n".getBytes());
            outputStream.flush();
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String isPersonPresent = strings[0];
            String isAssetsPresent = strings[1];

            if (isPersonPresent.equals("yes")) {
                name = strings[2];
            }
            ...
            if (isAssetsPresent.equals("yes")) {
                for (int i = 3; i < strings.length; i = i + 2) {
                    ...
                    double price = Double.parseDouble(strings[i + 1]);
